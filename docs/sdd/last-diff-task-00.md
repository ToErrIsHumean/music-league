...
+  }
+}
diff --git a/prisma.config.cjs b/prisma.config.cjs
new file mode 100644
index 0000000..5b7d892
--- /dev/null
+++ b/prisma.config.cjs
@@ -0,0 +1,50 @@
+const fs = require("fs");
